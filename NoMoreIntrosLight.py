...
foreLightColor = wx.Colour(72,72,72)
backLightColor = wx.Colour(250,250,250)
btnBackLightColor = wx.Colour(230, 230, 230)
...
class MainPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.backColor=backLightColor
        self.btnBackColor=btnBackLightColor
        self.foreColor=foreLightColor
